...
<html>
    ...
    <body>
        ...
        <header>
            ...
            <div id="datos">
                <p id="encabezado">
                    <b>IncanatoIT</b><br>James Giráldo 1999, Atlantico - Barranquilla, Colombia<br>Telefono:(+57)3152274804<br>Email: Jamesgiiraldo@gmail.com
                </p>
            </div>
            <div id="fact">
                ...
                <table id="facarticulo">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{$det->cantidad*$det->precio-$det->descuento}}</td>
                        </tr>
                        @endforeach
                    </tbody>
